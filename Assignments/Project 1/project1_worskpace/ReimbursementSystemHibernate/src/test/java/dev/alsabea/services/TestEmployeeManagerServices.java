...
//import dev.alsabea.entities.EmployeeManager;
//import dev.alsabea.services.impl.EmployeeManagerServicesImpl;
//
//@TestMethodOrder(OrderAnnotation.class)
//class TestEmployeeManagerServices {
//
//	private static EmployeeManagerServices  ems = EmployeeManagerServicesImpl.getInstance();
//	
//	@Test @Order(4)
...
//		
//		
//		long generatedId= ems.createInstance(emp);
//		
...
//		List<EmployeeManager> emps = ems.retrieveAll();
...
//		EmployeeManager emp = ems.retrieveById(1);
//		//( emp_id, first_name , last_name , username , password , emp_role, mgr_id)
...
//		EmployeeManager emp = ems.retrieveById(700);
//		//( emp_id, first_name , last_name , username , password , emp_role, mgr_id)
...
//		long generatedId= ems.createInstance(emp);
//		
//		EmployeeManager emp_updated = new EmployeeManager();
...
//		
//		
//		Assertions.assertTrue(ems.update(emp_updated));
//		
//	}
//
//	@Test
...
//		emp.setMgrId(3);
//		
//		Assertions.assertFalse(ems.update(emp));
//		
//	}
//	
//	
...
//		long generatedId= ems.createInstance(emp);
//		
//		Assertions.assertTrue(ems.deleteById(generatedId));
//		
//		
//	}
//
...
//		Assertions.assertFalse(ems.deleteById(9999));
//	}
//	
//	
//	
