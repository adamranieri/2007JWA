...
class TestEmployeeManagerServices {
	...
	final void testCreateInstance() {
		...
		int generatedId= ems.createInstance(emp);
	...
	final void testRetrieveAll() {
		List<Employee_Manager> emps = ems.retrieveAll();
	...
	final void testRetrieveById() {
		Employee_Manager emp = ems.retrieveById(1);
		//( emp_id, first_name , last_name , username , password , emp_role, mgr_id)
	...
	final void testRetrieveByIdNegative() {
		Employee_Manager emp = ems.retrieveById(700);
		//( emp_id, first_name , last_name , username , password , emp_role, mgr_id)
