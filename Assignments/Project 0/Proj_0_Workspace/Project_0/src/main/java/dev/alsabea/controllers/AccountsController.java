...
public class AccountsController {
	 ...
	 * 
	 * @returns Accounts with balance less than the specified -- if balancelessthan
	 *          query is used
	 * @returns Accounts with balance greater than the specified -- if
	 *          balancegreaterthan query is used
	 * @returns Accounts with balance in the specified range -- if both
	 *          (balancelessthan and balancegreaterthan) queries are used
	 * @returns all customer accounts if no query parameter is used
	 *
	 */
